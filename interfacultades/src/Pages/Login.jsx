...
const Login = () => {
    ...
    return( 
        <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-[#3A64BA] to-[#243E73]'>
            <form onSubmit={handdleLogin} noValidate className='bg-white p-8 rounded-xl shadow-md w-full max-w-md'>  
                ...
                <Input name='usmail' value={usmail} type='email' onChange={(event) => {setusmail(event.target.value); setError('')}} placeHolder='Correo electronico' />
                <Input name='uspass' value={uspass} type='password' onChange={(event) => {setUsPass(event.target.value); setError('')}} placeHolder='Contraseña'/>
